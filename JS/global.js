...
(5235,57-58): run-time error JS1195: Expected expression: >
(5235,83-84): run-time error JS1195: Expected expression: )
(5236,5-6): run-time error JS1002: Syntax error: }
(5238,41-42): run-time error JS1004: Expected ';': {
(5240,57-58): run-time error JS1195: Expected expression: >
(5240,84-85): run-time error JS1195: Expected expression: )
(5244,57-58): run-time error JS1195: Expected expression: >
(5244,83-84): run-time error JS1195: Expected expression: )
(5248,57-58): run-time error JS1195: Expected expression: >
(5248,84-85): run-time error JS1195: Expected expression: )
(5283,1-2): run-time error JS1002: Syntax error: }
(5291,57-58): run-time error JS1004: Expected ';': {
 */
...
(function ($) {
    ...
    $.fn.jwplayerView.embedFlash = function (player, options) {
        if (player.model.config.flashplayer) {
            var htmlString, elementvarString = "",
                flashvarString = "";
            if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) {
